package com.noomnoi.mysqlapplication;
...
/**
 * Created by Noomsi on 23/2/2560.
 */
...
public class MyListView extends BaseAdapter {
    ...
    public MyListView(Activity activity, ArrayList<TodoList> myTodoList) {
        ...
        this.activity = activity; inflater = (LayoutInflater)activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    }
